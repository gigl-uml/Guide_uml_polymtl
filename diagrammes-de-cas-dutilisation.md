...
| Extension de cas d'utilisation | ![](/out/plant_uml/useCaseExtensionExample/useCaseExtensionExample.svg) | Indique que le _casUtilisation1_ va ajouter des fonctionnalités (étendre) au _casUtilisation2_. Contrairement à l'inclusion, le cas d'utilisation de base (_casUtilisation2_) doit pouvoir fonctionner seul. |
