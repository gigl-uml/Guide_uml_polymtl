...
Les nœuds d'appareils, dénotés par le [stéréotypes](../ocl-stereotypes) **<<device>>**, représentent une **ressource informatique physique** capable d'effectuer des calculs.  
